...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in doubler_pb2_grpc.py depends on'
...
def add_DoublerServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('Doubler', rpc_method_handlers)
...
class Doubler(object):
    ...
    def Double(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/Doubler/Double',
            doubler__pb2.Number.SerializeToString,
            doubler__pb2.Number.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
